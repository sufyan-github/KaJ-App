...
| [CVE-2026-40345 / GHSA-ggr8-5vv4-36mx](https://github.com/advisories/GHSA-ggr8-5vv4-36mx) | `Prisma 6.19.3 > @prisma/config > deepmerge-ts` | The patch is a major dependency change inside Prisma; Prisma 7 also changes the configuration model and is outside this task. | Prisma configuration is developer-controlled at process startup. No request or user object is passed to `deepmerge-ts`. | At the P1-INF-03 database ADR decision, before production, or 2026-09-18. |
